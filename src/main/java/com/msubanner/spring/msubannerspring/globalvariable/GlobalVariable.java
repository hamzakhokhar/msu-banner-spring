...
public class GlobalVariable {
    ...
    public void setSCHOOLNAME(String school) { school = SCHOOLNAME; }

    public int getFRESHMAN() { return FRESHMAN; }
    public void setFRESHMAN(int freshman){ freshman = FRESHMAN; }

    public int getSOPHOMORE() { return SOPHOMORE; }
    public void setSOPHOMORE(int sophomore) { sophomore = SOPHOMORE; }

    public int getJUNIOR() { return JUNIOR; }
    public void setJUNIOR(int junior) { junior = JUNIOR; }

    public int getSENIOR() { return SENIOR; }
    public void setSENIOR (int senior) {senior = SENIOR;}
